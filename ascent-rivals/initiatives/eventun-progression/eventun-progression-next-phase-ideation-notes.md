...
Date: 2026-06-15
Related requirements: `ascent-rivals/archive/initiatives/eventun-progression/eventun-medals-progression-goals-challenges-rewards-requirements.md`
Related solution design: `ascent-rivals/archive/initiatives/eventun-progression/eventun-medals-progression-goals-challenges-rewards-solution-design.md`
Related authoring UI plan: `ascent-rivals/initiatives/eventun-progression/eventun-extend-app-ui-progression-authoring-design-plan.md`
Draft/publish implementation plan: `ascent-rivals/archive/initiatives/eventun-progression/eventun-progression-draft-publish-implementation-plan.md`
...
- The completed migration path is preserved in `ascent-rivals/archive/initiatives/eventun-progression/eventun-progression-draft-publish-implementation-plan.md`; review historical schema questions against that plan and current behavior against `ascent-rivals/system/eventun/progression.md`.
