# Ascent Rivals Archive

This directory contains inactive historical material excluded from default current-state
retrieval.
...
[pass 2 consolidation ledger](../../knowledge-base/initiatives/repository-restructure/pass-2-consolidation-ledger.md).

Archive content must not override `../system/` or active initiative documents.
