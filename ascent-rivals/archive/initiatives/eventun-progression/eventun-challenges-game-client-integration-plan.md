...
Archive notice: Historical client-integration plan. The current Eventun-backed challenge
surface is described in `ascent-rivals/system/eventun/progression.md` and
`ascent-rivals/system/game-client.md`.
