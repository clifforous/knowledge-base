...
Archive notice: Historical migration plan. Immutable published-snapshot behavior is described
in `ascent-rivals/system/eventun/progression.md`.

Status: Implementation plan draft
Date: 2026-06-16
Primary repository: `github.com/ikigai-github/eventun`
Related solution design: `ascent-rivals/initiatives/eventun-progression/eventun-medals-progression-goals-challenges-rewards-solution-design.md`
...
Related next-phase notes: `ascent-rivals/initiatives/eventun-progression/eventun-progression-next-phase-ideation-notes.md`
