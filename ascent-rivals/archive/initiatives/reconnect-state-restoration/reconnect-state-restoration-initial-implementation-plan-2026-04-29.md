...
> **Status:** Historical implementation plan. The durable runtime policy is [[ascent-rivals/system/race-roster-rules|race-roster-rules]]. Where this plan conflicts with that policy, the durable policy takes precedence.
