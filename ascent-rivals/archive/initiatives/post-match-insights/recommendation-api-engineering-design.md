...
Archive notice: Superseded recommendation design. The public product and API use Insights;
see `ascent-rivals/system/eventun/post-match-insights-rollout.md`.
