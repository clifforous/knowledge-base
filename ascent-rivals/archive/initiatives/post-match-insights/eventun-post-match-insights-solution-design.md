...
Archive notice: Historical implemented design. Use
`ascent-rivals/system/eventun/post-match-insights-rollout.md` for current behavior.
...
- `ascent-rivals/initiatives/post-match-insights/recommendation-api-engineering-design.md`
- `ascent-rivals/initiatives/post-match-insights/match-summary-time-trial-improvement-metrics.md`
