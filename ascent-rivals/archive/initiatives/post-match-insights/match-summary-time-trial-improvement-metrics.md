...
Archive notice: Historical metric exploration superseded by the implemented Insights
contract in `ascent-rivals/system/eventun/post-match-insights-rollout.md`.
